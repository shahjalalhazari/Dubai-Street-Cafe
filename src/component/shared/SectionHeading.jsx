const SectionHeading = ({ subtitle, title, align = "center"}) => {
  ...
  const styles = {
    ...
    subTitle: "font-medium body-text uppercase tracking-[4px] lg:tracking-[8px] text-(--accent) text-lg md:text-2xl",
    title: "text-3xl md:text-5xl lg:text-6xl font-bold text-(--dark) heading"
  }
